...
#import "LogInmainViewController.h" //登录
// Models
...
- (void)setUpHeadView
{
    ...
    _headView.headViewTouchBlock = ^{
        NSLog(@"点击了头部View");
//        AFParentsViewController * parentVC = [[AFParentsViewController alloc]init];
//        [myself.navigationController pushViewController:parentVC animated:YES];
