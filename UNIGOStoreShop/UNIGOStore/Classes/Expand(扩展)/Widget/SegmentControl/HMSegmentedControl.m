...
- (id)initWithSectionTitles:(NSArray *)sectiontitles andMode:(int)mode {
    self = [super initWithFrame:CGRectZero];
...
//        if (IOS_VERSION >= 7.0) {
//            stringHeight = [titleString sizeWithAttributes:@{ NSFontAttributeName :[UIFont fontWithName:self.font.fontName size:16] }].height;///ios7之后
//
//        }else{
...
//        }
        ...
        switch (self.customMode){
            case 0:
                rect = CGRectMake(self.segmentWidth * idx, y, self.segmentWidth, stringHeight);
                break;
            case 1: //大本营自定义模式
                if(idx == 0){
                    rect = CGRectMake(self.segmentWidth * idx - 15, y, self.segmentWidth, stringHeight);
...
//        NSDictionary *attributes = @{ NSFontAttributeName: [UIFont fontWithName:self.font.fontName size:16],
...
- (CGRect)frameForSelectionIndicator {
    CGFloat stringWidth = [[self.sectionTitles objectAtIndex:self.selectedIndex] sizeWithFont:self.font].width+50;   /// iOS7 前
    
//    CGFloat stringWidth = [[self.sectionTitles objectAtIndex:self.selectedIndex] sizeWithAttributes:@{ NSFontAttributeName :[UIFont fontWithName:self.font.fontName size:16] }].width;///ios7之后
...
- (void)updateSegmentsRects {
    ...
    CGFloat stringWidth = [titleString sizeWithFont:self.font].width + self.segmentEdgeInset.left + self.segmentEdgeInset.right;  ////ios6 之前
            
//    CGFloat stringWidth = [titleString sizeWithAttributes:@{ NSFontAttributeName : self.font }].width+ self.segmentEdgeInset.left + self.segmentEdgeInset.right ;///ios7之后
