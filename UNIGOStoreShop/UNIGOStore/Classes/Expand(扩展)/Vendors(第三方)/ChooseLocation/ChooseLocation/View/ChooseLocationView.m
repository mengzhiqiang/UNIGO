...
@property (nonatomic,strong) NSArray * DataSoucePlist;
...
-(NSArray*)DataSoucePlist{
    
    if (!_DataSoucePlist) {
        NSString *path = [[NSBundle mainBundle] pathForResource:@"unigo_city" ofType:@"plist"];
        _DataSoucePlist = [NSArray arrayWithContentsOfFile:path];
    }
    return _DataSoucePlist;
}
@end
