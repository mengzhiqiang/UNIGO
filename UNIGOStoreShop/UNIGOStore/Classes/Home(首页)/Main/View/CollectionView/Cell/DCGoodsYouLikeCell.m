...
- (void)setYouLikeItem:(DCHomeRecommend *)youLikeItem
{
    [_goodsImageView sd_setImageWithURL:[NSURL URLWithString:youLikeItem.image]];
    _priceLabel.text = [NSString stringWithFormat:@"%@",youLikeItem.desc ];
